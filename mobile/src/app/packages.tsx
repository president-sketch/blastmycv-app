...
import { ArrowLeft, Check, Star, Zap, Globe, ChevronRight } from 'lucide-react-native';
      ...
      <SafeAreaView style={{ flex: 1 }} edges={['top']}>
        ...
        <View style={{
          ...
          <View style={{ flex: 1, marginLeft: 14 }}>
            ...
            <Text style={{ color: '#888899', fontSize: 13, marginTop: 1 }}>
    ...
    >
      ...
      {pkg.isPopular ? (
        ...
        >
          ...
          <Text style={{ color: '#FFFFFF', fontSize: 11, fontWeight: '700', letterSpacing: 0.8 }}>
            MOST POPULAR
          </Text>
        </LinearGradient>
      ) : null}
      ...
      <View style={{ padding: 20 }}>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 8 }}>
          <View style={{ flex: 1, marginRight: 12 }}>
            ...
            <Text style={{ color: '#888899', fontSize: 13, lineHeight: 18 }}>
              {pkg.description}
            </Text>
          </View>
          <View style={{ alignItems: 'flex-end' }}>
            <Text style={{ color: '#FF6B35', fontSize: 24, fontWeight: '800' }}>
              ${pkg.price}
            </Text>
        ...
        <View style={{
          ...
          <Text style={{ color: '#FF6B35', fontSize: 13, fontWeight: '600' }}>
            {pkg.employersReached} employers reached
          </Text>
        </View>
